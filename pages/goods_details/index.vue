...
<script>
	...
	export default {
		...
		computed: mapGetters(['isLogin','productDetail']),
		onLoad(options) {
			let that = this
		...
		methods: {
			...
			getGoodsDetails: function() {
				...
				let tempProductDetail = JSON.parse(JSON.stringify(this.productDetail))
				let storeInfo = tempProductDetail.storeInfo;
				let good_list = tempProductDetail.good_list || [];
				...
				that.$set(that, 'reply', tempProductDetail.reply ? [tempProductDetail.reply] : []);
				that.$set(that, 'replyCount', tempProductDetail.replyCount);
				that.$set(that, 'replyChance', tempProductDetail.replyChance);
				that.$set(that.attr, 'productAttr', tempProductDetail.productAttr);
				that.$set(that, 'productValue', tempProductDetail.productValue);
				that.$set(that.sharePacket, 'priceName', tempProductDetail.priceName);
				that.$set(that, 'systemStore', tempProductDetail.system_store);
				that.$set(that, 'storeSelfMention', tempProductDetail.store_self_mention);
				that.$set(that, 'good_list', goodArray);
				that.$set(that, 'PromotionCode', storeInfo.code_base);
				that.$set(that, 'activity', tempProductDetail.activity ? tempProductDetail.activity : []);
